...
namespace Entities.Config
{
    public class ProductConfig : IEntityTypeConfiguration<Product>
    {
        ...
        public void Configure(EntityTypeBuilder<Product> builder)
        {
            ...
            //    new Product { Id=92, ProductTypeID=6, ProductName="Pirinç Pilav", UnitCalorie=3.52, Image=ReadFile("Resources/antrikot.png") },
            //    new Product { Id=93, ProductTypeID=6, ProductName="Pizza", UnitCalorie=2.67, Image=ReadFile("Resources/antrikot.png") },
            //    new Product { Id=94, ProductTypeID=6, ProductName="Yaprak Sarması", UnitCalorie=1.41, Image=ReadFile("Resources/antrikot.png") },
            //    new Product { Id=95, ProductTypeID=6, ProductName="Zeytinyağlı Dolma", UnitCalorie=1.73, Image=ReadFile("Resources/antrikot.png") },
